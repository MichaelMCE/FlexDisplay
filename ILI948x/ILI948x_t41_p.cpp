...
FASTRUN void ILI948x_t41_p::setAddrWindow (uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2) 
{
	...
	//SglBeatWR_nPrm_8(ILI9488_RAMWR, 0, 0); //Set ILI9488 to expect RAM data for pixels, resets column and page regs
...
PROGMEM static const uint8_t initCommands[] = 
{
	...
	ILI9488_PWCTR1,     1, 0x0d,           	  // Power Control 1
	ILI9488_PWCTR2,     1, 0x41,              // Power Control 2
	ILI9488_PWCTR3,     1, 0x00,              // Power Control 3 (For Normal Mode)
	
	//ILI9488_VMCTR1,     3, 0x00, 0x12, 0x80,        // VCOM control
	ILI9488_VMCTR1,     2, 0x00, 0x35,        // VCOM control
	ILI9488_INVCTR,     1, 0x00,                    // Display Inversion Control
	ILI9488_DFUNCTR,    3, 0x00, 0x02, 0x3B,	    // Display Function Control  RGB/MCU Interface Control
	ILI9488_ETMOD,      1, 0x07,                    // Entry Mode Set
	
	// Gamma Setting	   
	//ILI9488_PGAMCTRL, 15, 0x0F, 0x1F, 0x1C, 0x0C, 0x0F, 0x08, 0x48, 0x98, 0x37, 0x0A, 0x13, 0x04, 0x11, 0x0D, 0x00,		// orig ili9488
	ILI9488_PGAMCTRL, 15, 0x0F, 0x10, 0x08, 0x05, 0x09, 0x05, 0x37, 0x98, 0x26, 0x07, 0x0F, 0x02, 0x09, 0x07, 0x00,		// darker
	//ILI9488_PGAMCTRL, 15, 0x0F, 0x1B, 0x18, 0x0B, 0x0E, 0x09, 0x47, 0x94, 0x35, 0x0A, 0x13, 0x05, 0x08, 0x03, 0x00,			// brighter
	
    //ILI9488_NGAMCTRL, 15, 0x0F, 0x32, 0x2E, 0x0B, 0x0D, 0x05, 0x47, 0x75, 0x37, 0x06, 0x10, 0x03, 0x24, 0x20, 0x00,		// orig
    ILI9488_NGAMCTRL, 15, 0x0F, 0x38, 0x36, 0x0D, 0x10, 0x08, 0x59, 0x76, 0x48, 0x0A, 0x16, 0x0A, 0x37, 0x2F, 0x00,		// darker
	//ILI9488_NGAMCTRL, 15, 0x0F, 0x3A, 0x37, 0x0B, 0x0C, 0x05, 0x4A, 0x24, 0x39, 0x07, 0x10, 0x04, 0x27, 0x25, 0x00,			// brighter
	// Other commands  
	ILI9488_MADCTL,     1, 0x08,                    // Memory Access Control : 0x48 is equivalent to _rotation = 0
